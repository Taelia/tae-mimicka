...
namespace Tomestone.Models
{
    public class Main
    {
        ...
        {
            Main.Db.SafeQuery("CREATE TABLE IF NOT EXISTS users ( userId INTEGER PRIMARY KEY AUTOINCREMENT, user NOT NULL UNIQUE, messageCount NOT NULL DEFAULT ( '0' ), visitCount NOT NULL DEFAULT ( '0' ), kappaCount NOT NULL DEFAULT ( '0' ), heartCount NOT NULL DEFAULT ( '0' ), firstSeen DATE NOT NULL DEFAULT ( '01-01-2014' ), lastSeen DATE NOT NULL DEFAULT ( '01-01-2014' ), lastSpoke DATE NOT NULL DEFAULT ( '01-01-2014' ), firstGame NOT NULL DEFAULT ( 'None' ), lastGame NOT NULL DEFAULT ( 'None' ) );");
        }
    }
}
